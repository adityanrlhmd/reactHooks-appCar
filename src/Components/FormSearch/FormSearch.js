            ...
            <Container className="wrap-search p-4">
                ...
                <h6 className="fw-bold px-4">{!props.cari ? "Pencarianmu" : ""}</h6>
                    <Row>
                        <Col md={props.show ? "10" : "12"}>
                            <Row className="form-search">
                                <Col className="tipe-driver" md="3">
                                    <FormGroup>
                                        <Label for="tipeDriver">
                                            Tipe Driver
                                        </Label>    
                                        <Input id="tipeDriver" name="tipe-driver" type="select" placeholder="Pilih Tipe Driver" disabled={props.form}>
                                ...
                                <Col className="waktu-jemput" md="3">
                                    <FormGroup>
                                        <Label for="waktuJemput">
                                            Time
                                        </Label>
                                        <Input id="waktuJemput" name="waktu-jemput" type="select" placeholder="Pilih Waktu" disabled={props.form}>
                                            <option className="d-flex"> <span className="">08.00</span> <span className="ms-auto">WIB</span> </option>
                        ...
                        <Col className={props.show ? 'my-auto d-flex' : 'd-none'} md={props.show ? "2" : ""}>
                            <Link to='/cari' className={`btn  mx-auto ${props.edit ? 'btn btn-outline-primary' : 'btn-search btn-success'}`}>
