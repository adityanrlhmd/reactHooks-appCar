                            ...
                            <div className="col-md-8">
                                ...
                                <div className="row flex-row-reverse mt-4 clearfix">
                                    <div className="col-md-4 float-right">
                                        <Link to="/cars/add" className="btn btn-card btn-bayar btn-success w-100">
                            ...
                            <div className="col-md-4">
                                <div className="card">
                                    <div className="card-body p-3">
                                        ...
                                        <h5 className="title-detail fw-bold">{item.name}/{item.category}</h5>
                                        ...
                                        <div className="d-flex px-2 justify-content-between">
                                            ...
                                            <div className="ms-auto fw-bold" style={{textAlign:'right'}}>Rp. {item.price}</div>
                                        </div>

                                        <div className="container mt-2 px-0">
                                            <Link to="/cars/add" className="btn btn-bayar btn-success w-100">
                                                Lanjutkan pembayaran
                                            </Link>
                                        </div>
                                    </div>
